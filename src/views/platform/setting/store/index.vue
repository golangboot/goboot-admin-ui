        ...
        <el-form ref="form" :model="form" :rules="rules" label-width="150px" style="margin-top: 20px">
            ...
            <el-row :gutter="20">
              <el-col :span="12">
                <el-form-item label="商品评价显示状态" prop="product.openCommentStatus">
                  ...
                  <el-switch v-model="form['store.product.openCommentStatus']" class="form-switch" inline-prompt style="
                      --el-switch-on-color: #13ce66;
                      --el-switch-off-color: #ff4949;
            ...
            <el-row :gutter="20">
              ...
              <el-col :span="12" v-if="form['store.product.mobileBuyType'] == 'IMAGE'">
                <el-form-item label="手机端购买二维码" prop="product.mobileBuyQrCodeUrl" clearable>
                  ...
                  <sc-upload :width="80" :height="80" v-model="form['store.product.mobileBuyQrCodeUrl']"
          ...
          <el-tab-pane label="订单设置">
            <el-form-item label-width="180px" label="订单自动关闭时间(分钟)" prop="order.autoCloseOrderTimer">
              <el-input-number v-model="form['store.order.autoCloseOrderTimer']"
            ...
            <el-form-item label-width="180px" label="订单自动收货时间(天)" prop="order.autoTakeOrderTimer">
              <el-input-number v-model="form['store.order.autoTakeOrderTimer']"
                controls-position="right"></el-input-number>
            ...
            <el-row :gutter="20">
              <el-col :span="12">
                <el-form-item label-width="180px" label="订单自动好评状态" prop="order.openAutoComment">
                  <el-switch v-model="form['store.order.openAutoComment']" class="form-switch" inline-prompt style="
                      --el-switch-on-color: #13ce66;
                      --el-switch-off-color: #ff4949;
                    " :active-value="'1'" :inactive-value="'0'" active-text="开启" inactive-text="关闭" />
                  <div class="el-form-item-msg">
              ...
              <el-col :span="12">
                <el-form-item label-width="180px" label="订单自动好评触发时间(天)" prop="order.autoCommentTimer">
                  <el-input-number v-model="form['store.order.autoCommentTimer']"
                    controls-position="right"></el-input-number>
                </el-form-item>
              </el-col>
            </el-row>
            <el-form-item label-width="180px" label="订单退款理由" prop="order.orderRefundReason">
              <el-input v-model="form['store.order.orderRefundReason']" :autosize="{ minRows: 6, maxRows: 12 }"
            ...
            <el-row :gutter="20">
              <el-col :span="12">
                <el-form-item label-width="180px" label="显示商家店铺" prop="merchant.isShowMerchant">
                  ...
                  <el-switch v-model="form['store.merchant.isShowMerchant']" class="form-switch" inline-prompt style="
                      --el-switch-on-color: #13ce66;
                      --el-switch-off-color: #ff4949;
                    " :active-value="'1'" :inactive-value="'0'" active-text="开启" inactive-text="关闭" />
                </el-form-item>
            ...
            <el-row :gutter="20">
              <el-col :span="12">
                <el-form-item label-width="180px" label="开启商家入驻" prop="merchant.openMerchantApply">
                  ...
                  <el-switch v-model="form['store.merchant.openMerchantApply']" class="form-switch" inline-prompt style="
                      --el-switch-on-color: #13ce66;
                      --el-switch-off-color: #ff4949;
                    " :active-value="'1'" :inactive-value="'0'" active-text="开启" inactive-text="关闭" />
                </el-form-item>
            ...
            <el-row :gutter="20">
              <el-col :span="12">
                <el-form-item label-width="180px" label="商家资质是否必传" prop="merchant.certificationRequired">
                  ...
                  <el-switch v-model="form['store.merchant.certificationRequired']" class="form-switch" inline-prompt
                    style="
                      --el-switch-on-color: #13ce66;
                      --el-switch-off-color: #ff4949;
                    " :active-value="'1'" :inactive-value="'0'" active-text="开启" inactive-text="关闭" />
            ...
            <el-row :gutter="20">
              <el-col :span="12">
                <el-form-item label-width="180px" label="店铺保证金图标状态" prop="merchant.depositIconShowStatus">
                  ...
                  <el-switch v-model="form['store.merchant.depositIconShowStatus']" class="form-switch" inline-prompt
                    style="
                      --el-switch-on-color: #13ce66;
                      --el-switch-off-color: #ff4949;
                    " :active-value="'1'" :inactive-value="'0'" active-text="显示" inactive-text="隐藏" />
              ...
              <el-col :span="12">
                <el-form-item label-width="180px" label="店铺保证金图标" prop="merchant.depositIcon" clearable>
                  ...
                  <sc-upload :width="80" :height="80" v-model="form['store.merchant.depositIcon']"
                    title="请上传图片"></sc-upload>
                </el-form-item>
              </el-col>
            </el-row>
