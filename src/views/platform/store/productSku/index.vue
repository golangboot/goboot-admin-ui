		...
		<el-container class="is-vertical">
			...
			<el-main class="nopadding">
				<scTable ref="table" :apiObj="apiObj" :params="params" row-key="id" @selection-change="selectionChange" stripe>
					...
					<el-table-column label="商品Sku名称" prop="name" width="150" :show-overflow-tooltip="true"></el-table-column>
					...
					<el-table-column label="库存" prop="stock" header-align="center" align="right" min-width="120" sortable></el-table-column>
					<el-table-column label="商家编码" prop="code" width="150" :show-overflow-tooltip="true"></el-table-column>
					<el-table-column label="商品条形码" prop="barCode" width="150" :show-overflow-tooltip="true"></el-table-column>
					<el-table-column label="重量(KG)" prop="weight" width="100" :show-overflow-tooltip="true"></el-table-column>
					<el-table-column label="体积(m³)" prop="volume" width="100" :show-overflow-tooltip="true"></el-table-column>
					<el-table-column label="商品ID" prop="productId" width="150" :show-overflow-tooltip="true"></el-table-column>
					<el-table-column label="商家ID" prop="merchantId" width="150" :show-overflow-tooltip="true"></el-table-column>
	...
	export default {
		...
		data() {
			return {
				...
				apiObj: this.$API.platform.store.productSku.list,
				params: {},
				selection: [],
				search: {
					keyword: null
		...
		methods: {
			...
			async table_del(row){
				...
				var res = await this.$API.platform.store.productSku.delete.delete(reqData);
				if(res.code == 200){
			...
			async changeSwitch(val, row){
				...
				var res = await this.$API.platform.store.productSku.update.put(reqData);
