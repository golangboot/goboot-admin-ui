		...
		<el-container class="is-vertical">
			...
			<el-main class="nopadding">
				<scTable ref="table" :apiObj="apiObj" :params="params" row-key="id" @selection-change="selectionChange" stripe>
					...
					<el-table-column label="属性值录入方式" prop="inputType" width="150" sortable>
						<template #default="scope">
							<el-tag v-if="scope.row.inputType==1" type="success">从列表中选取</el-tag>
							<el-tag v-if="scope.row.inputType==0" type="warning">手工录入</el-tag>
						</template>
					</el-table-column>
					<el-table-column label="属性值可选值列表" prop="inputList" width="200" :show-overflow-tooltip="true"></el-table-column>
					...
					<el-table-column label="支持新增属性" prop="canAddAttribute" width="130" sortable>
						<template #default="scope">
