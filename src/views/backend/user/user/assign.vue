			...
			submit(){
				this.$refs.dialogForm.validate(async (valid) => {
					if (valid) {
						...
						var res;
						if (this.mode == 'group'){
							res = await this.$API.backend.user.user.assignGroups.post(this.form)
						}
						if (this.mode == 'role'){
							res = await this.$API.backend.user.user.assignRoles.post(this.form)
						}
						if (this.mode == 'department'){
							res = await this.$API.backend.user.user.assignDepartments.post(this.form)
						}
